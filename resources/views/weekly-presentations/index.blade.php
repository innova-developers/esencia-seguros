...
@section('title', 'Listado de Presentaciones Semanales')
        ...
        <div class="col-12">
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('weekly-presentations.create') }}" class="btn btn-light">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" class="row g-3 mb-3 align-items-end">
                        ...
                        <div class="col-md-3">
                            <label for="cronograma" class="form-label">Semana</label>
                            <input type="text" name="cronograma" id="cronograma" class="form-control" value="{{ request('cronograma') }}" placeholder="Ej: 2025-25">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 text-end">
                            ...
                            <a href="{{ route('weekly-presentations.index') }}" class="btn btn-outline-secondary ms-2">
                                Limpiar
                            </a>
                        </div>
                    </form>
                        ...
                        <table class="table table-striped table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('weekly-presentations.show', $presentation->id) }}" class="btn btn-sm btn-outline-primary" title="Ver detalles">
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">No hay presentaciones semanales registradas.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
